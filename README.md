...
# STEP 2
# Using a text editor, modify parameters like burnin, samplefreq, and/or nsample parameters
# in the ctlTemplate.ctl file if necessary before proceeding. You may also want to specify
